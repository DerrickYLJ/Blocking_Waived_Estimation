...
# case 4 : VL4
# ES1 -> (VL1 + VL11L) -> Switch A -> (VL9L) -> ES3
# No VL6
...
t1 = source_fromES1.bind_task(model.Task("T1", wcet=30, bcet=1, scheduling_parameter=2))
t2 = first.bind_task(model.Task("VL1 + VL11L", wcet=129, bcet=1, scheduling_parameter=2))
t3 = switch_to_ES3.bind_task(model.Task("T3", wcet=30, bcet=1, scheduling_parameter=2))
t4 = second.bind_task(model.Task("VL9L", wcet=121, bcet=1, scheduling_parameter=2))
