...
# case 20 : VL13
# ES4 -> (VL6) -> Switch A -> (VL2 + VL3 + VL7 + VL9) -> Switch B -> (VL4 + VL8 + VL11) -> ES4
...
t1 = source_fromES4.bind_task(model.Task("T1", wcet=30, bcet=1, scheduling_parameter=2))
t2 = first.bind_task(model.Task("VL6", wcet=8, bcet=1, scheduling_parameter=2))
t3 = switchB_to_A.bind_task(model.Task("T3", wcet=30, bcet=1, scheduling_parameter=2))
t4 = second.bind_task(model.Task("VL2 + VL3 + VL7 + VL9", wcet=173, bcet=1, scheduling_parameter=2))
t5 = switchA_to_ES3.bind_task(model.Task("T5", wcet=30, bcet=1, scheduling_parameter=2))
t6 = third.bind_task(model.Task("VL4 + VL8 + VL11", wcet=163, bcet=0, scheduling_parameter=2))
