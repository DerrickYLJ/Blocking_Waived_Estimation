...
# case 12 : VL9 to ES3
# ES2 -> (VL2 + VL3 + VL7) -> Switch B -> (VL6 + VL13) -> Switch A -> (VL4 + VL8 + VL11) -> ES3
...
t5 = switchA_to_ES3.bind_task(model.Task("T5", wcet=121, bcet=1, scheduling_parameter=2))
t6 = third.bind_task(model.Task("VL4 + VL8 + VL11", wcet=165, bcet=0, scheduling_parameter=2))
