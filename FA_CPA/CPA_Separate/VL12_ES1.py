...
# case 18 : VL12 to ES1
# ES3 -> (VL10 + VL5) -> Switch A -> (VL2 + VL9L + VL6 + VL7) -> ES1
...
t2 = first.bind_task(model.Task("VL10 + VL5", wcet=38, bcet=1, scheduling_parameter=2))
t3 = switch_to_ES1.bind_task(model.Task("T3", wcet=14, bcet=1, scheduling_parameter=2))
t4 = second.bind_task(model.Task("VL2 + VL9L + VL6", wcet=137, bcet=1, scheduling_parameter=2))
