...
# case 2 : VL2
# ES2 -> (VL3 + VL9L) -> Switch B -> (VL6 + VL13L) -> Switch A -> (VL5 + VL12L) -> ES1
...
t1 = source_fromES2.bind_task(model.Task("T1", wcet=8, bcet=1, scheduling_parameter=2))
t2 = first.bind_task(model.Task("VL3 + VL9L", wcet=151, bcet=1, scheduling_parameter=2))
...
t5 = switchB_to_ES1.bind_task(model.Task("T5", wcet=8, bcet=1, scheduling_parameter=2))
