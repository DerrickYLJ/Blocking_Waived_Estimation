...
# ES3 -> (VL5 + VL12) -> Switch A -> (VL1 + VL8 + VL11) -> Switch B -> (VL9) -> ES4
...
t1 = source_fromES3.bind_task(model.Task("T1", wcet=30, bcet=1, scheduling_parameter=2))
t2 = first.bind_task(model.Task("VL5 + VL12", wcet=22, bcet=1, scheduling_parameter=2))
t3 = switchA_to_B.bind_task(model.Task("T3", wcet=30, bcet=1, scheduling_parameter=2))
t4 = second.bind_task(model.Task("VL1 + VL8 + VL11", wcet=143, bcet=1, scheduling_parameter=2))
t5 = switchB_to_ES4.bind_task(model.Task("T5", wcet=30, bcet=1, scheduling_parameter=2))
t6 = third.bind_task(model.Task("VL9", wcet=121, bcet=1, scheduling_parameter=2))
